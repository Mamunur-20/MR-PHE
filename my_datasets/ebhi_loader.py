...
class EBHIDataset(VisionDataset):
    """Custom Dataset for EBHI Histopathology Images."""
    ...
    def __init__(
        ...
        self.loader = loader
        self._split = split
        self._base_folder = Path(self.root) / "ebhi"
        self._classes = ['Benign', 'Malignant']
...
#        #self._classes = ['Benign', 'Malignant']
#        self._classes = [
#            "Low grade interepithelial neoplasia",
#            "High grade interepithelial neoplasia",
#            "Normal",
#            "Adenocarcinoma",
#            "Polyp"
#        ]
